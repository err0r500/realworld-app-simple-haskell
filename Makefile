build:
	hpack
	cabal build exe:haskell-clean-architecture-exe
	cp ./dist-newstyle/build/x86_64-linux/ghc-8.10.7/haskell-clean-architecture-0.1.0.0/x/haskell-clean-architecture-exe/build/haskell-clean-architecture-exe/haskell-clean-architecture-exe ./app-exe

run:
	cabal run haskell-clean-architecture-exe
