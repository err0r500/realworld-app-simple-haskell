...
spec r reset = do
  ...
  -- Get User
    ...
    describe "find user by email" $ it "succeeds" $ \logs -> do
      Right result <- appToIO logs $ do
        Nothing <- UC._insertUserPswd r user ""
        Nothing <- UC._insertUserPswd r otherUser ""
    ...
    describe "find user by name" $ it "succeeds" $ \logs -> do
      Right result <- appToIO logs $ do
        Nothing <- UC._insertUserPswd r user ""
        Nothing <- UC._insertUserPswd r otherUser ""
